    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[var(--wood-shadow)]/70 p-4">
      <div className="manuscript-bg max-h-[85vh] w-full max-w-lg overflow-y-auto rounded-sm border border-[var(--paper-grid)] p-6 shadow-2xl">
        ...
        <div className="mt-5 space-y-5 font-sans text-sm leading-relaxed text-[color-mix(in_srgb,var(--ink)_85%,transparent)]">
          <section>
            <p className="text-xs font-bold tracking-[0.2em] text-[var(--stamp-red)] uppercase">
              1단계 · 필수 통과 기준
            </p>
            ...
            <div className="mt-3 space-y-3">
              <div>
                <p className="font-bold">1. 정보 및 상황의 등가성</p>
                <p className="mt-1 text-[color-mix(in_srgb,var(--ink)_65%,transparent)]">
              ...
              <div>
                <p className="font-bold">2. 서사적 기능의 유지</p>
                <p className="mt-1 text-[color-mix(in_srgb,var(--ink)_65%,transparent)]">
          ...
          <section>
            ...
            <div className="mt-3 space-y-3">
              <div>
                <p className="font-bold">1. 이미지의 선명도</p>
                <p className="mt-1 text-[color-mix(in_srgb,var(--ink)_65%,transparent)]">
              ...
              <div>
                <p className="font-bold">2. 리듬과 운율</p>
                <p className="mt-1 text-[color-mix(in_srgb,var(--ink)_65%,transparent)]">
              ...
              <div>
                <p className="font-bold">3. 정서적 잔향</p>
                <p className="mt-1 text-[color-mix(in_srgb,var(--ink)_65%,transparent)]">
              ...
              <div>
                <p className="font-bold">4. 함축성과 참신함</p>
                <p className="mt-1 text-[color-mix(in_srgb,var(--ink)_65%,transparent)]">
              ...
              <div>
                <p className="font-bold">5. 맥락적 부합성</p>
                <p className="mt-1 text-[color-mix(in_srgb,var(--ink)_65%,transparent)]">
        ...
        <div className="mt-6 flex items-center justify-end">
          <button
            type="button"
            onClick={onClose}
            className="rounded-sm bg-[var(--stamp-red)] px-4 py-1.5 font-sans text-sm font-bold text-[var(--paper-cream)]"
          >
            확인
          </button>
        </div>
